...
<body>
    ...
    <table>
        <tr>
            ...
            <th style="color:green;">Number of days</th>
        ...
        <tr>
            ...
            ?>
        <tr>
            <td><?php echo $item->RLEAVE_ID ?></td>
            <td><?php echo $item->EMPLOYEE_ID ?></td>
            <td><?php echo $item->NUMBER_DAYS ?></td>
            <td><?php echo $item->CREATE_DATE ?></td>
            <td><?php echo $item->REASON ?></td>
            <td><?php echo $item->LEAVE_FROM ?></td>
            <td><?php echo $item->LEAVE_TO ?></td>
            <td><?php echo $item->STATUS ?></td>
            <td>
                
                <form action="<?= $host_name ?>/home/verify_request_leave_accept" method="post">
                    <input type="hidden" id="request_id_id" name="request_id" value="<?php echo $item->RLEAVE_ID  ?>">
                ...
                <form action="<?= $host_name ?>/home/verify_request_leave_reject_page" method="post">
                    <input type="hidden" id="request_id_id" name="request_id" value="<?php echo $item->RLEAVE_ID ?>">
                ...
                <form action="<?= $host_name ?>/home/verify_request_leave_submit" method="post">
                    <input type="hidden" id="request_id_id" name="request_id" value="<?php echo $item->RLEAVE_ID  ?>">
                    <input type="submit" class="button" style="margin-left:0px;" id="submit_request_button" value="Submit for approved" style="color:#059669; background:white;"/>
                </form>
                &nbsp;
