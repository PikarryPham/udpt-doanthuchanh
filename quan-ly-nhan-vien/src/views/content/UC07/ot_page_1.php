...
<body>
    ...
    <table>
        <tr>
            ...
            <th style="color:green;">Estimate Hour</th>
        ...
        <tr>
            ...
            ?>
        <tr>
            <td><?php echo $item->ROT_ID ?></td>
            <td><?php echo $item->EMPLOYEE_ID ?></td>
            <td><?php echo $item->CREATE_DATE ?></td>
            <td><?php echo $item->REASON ?></td>
            <td><?php echo $item->START_DATE ?></td>
            <td><?php echo $item->END_DATE ?></td>
            <td><?php echo $item->ESTIMATED_HOURS ?></td>
            <td><?php echo $item->STATUS ?></td>
            <td>
                
                <form action="<?= $host_name ?>/home/verify_request_ot_accept" method="post">
                    <input type="hidden" id="request_id_id" name="request_id" value="<?php echo $item->ROT_ID  ?>">
                ...
                <form action="<?= $host_name ?>/home/verify_request_ot_reject_page" method="post">
                    <input type="hidden" id="request_id_id" name="request_id" value="<?php echo $item->ROT_ID ?>">
