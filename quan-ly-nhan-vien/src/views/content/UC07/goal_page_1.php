...
<body>
    ...
    <table>
        <tr>
            ...
            <th style="color:green;">Last Update Date</th>
            <th style="color:green;">Total Goal</th>
        ...
        <tr>
            ...
            ?>
        <tr>
            <td><?php echo $item->PAGOAL_ID ?></td>
            <td><?php echo $item->EMPLOYEECREATE_ID ?></td>
            <td><?php echo $item->LASTUPDATE_DATE ?></td>
            <td><?php echo $item->TOTAL_GOALS ?></td>
            <td><?php echo $item->DEADLINE_PAGOAL ?></td>
            <td><?php echo $item->STATUS ?></td>
            <td>
                
                <form action="<?= $host_name ?>/home/verify_request_goal_accept" method="post">
                    <input type="hidden" id="request_id_id" name="request_id" value="<?php echo $item->PAGOAL_ID  ?>">
                ...
                <form action="<?= $host_name ?>/home/verify_request_goal_reject_page" method="post">
                    <input type="hidden" id="request_id_id" name="request_id" value="<?php echo $item->PAGOAL_ID ?>">
