<!-- <div class="modal-error-fix js-modal-error-fix">
        <div class="modal-contain js-modal-contain">
                <div class="modal-close-fix js-modal-close_fix">
                    <i class="fa-solid fa-xmark"></i>
                </div>
            <div class="modal-content">
                <i class="fa-regular fa-circle-xmark"></i>
                <p style="text-transform: none;">You CAN ONLY edit leave request that has status is Draft or Pending</p>
            </div>
        </div>
    </div>
    ...
    <div class="modal-error js-modal-error">
        <div class="modal-contain js-modal-contain">
            ...
            <div class="modal-content">
                <i class="fa-regular fa-circle-xmark"></i>
                <p style="text-transform: none;">You CAN ONLY delete leave request that has status is Draft</p>
            </div>
        </div>
    </div> -->
    ...
    <div class="modal-delete-co js-modal-del-co">
        <div class="modal-contain js-modal-contain-co">
            ...
            <div class="modal-content">
                <p>congratulations! you deleted this request successfully</p>
                <a href="#" class="btn ok-btn">OK</a>
            </div>
        </div>
    </div>